...
public class BulkUploadServiceImpl implements BulkUploadService {
	...
	private static final List<String> VALID_COLUMNS = List.of("SiteCode", "AtmId", "Channel Manager", "Site Area",
			...
			"Agreement Status", "Escalation %", "Escalation After(Months)");// rentagreementmaster
	...
	private RentAgreementMaster processRentAgreement(Row row, SiteMaster siteMaster, LandlordMaster landlordMaster) {
		...
		// Convert payInterval to int (1 for monthly, 3 for quarterly)
		int paymentInterval;
		...
		case "quarterly":
			...
			break;
		default:
			throw new RuntimeException("Invalid pay interval. Expected 'monthly' or 'quarterly'");
		}
