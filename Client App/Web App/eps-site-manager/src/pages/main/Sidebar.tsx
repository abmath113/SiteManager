                    ...
                    <IconContext.Provider value={{ color: "#0099cc", size: '1em' }}>
                        <ul className="sidebar-nav p-0 ">
                            ...
                            <li className="sidebar-header px-1">Masters</li>
                                ...
                                <li className={`sidebar-item ${location.pathname === '/channelmanagersearch' ? 'active gradient-active' : ''}`}>
                                    <Link className="sidebar-link" to="channelmanagersearch">
                                    <span className="align-middle"><BsPersonVideo /></span>
                                    <span className="align-middle">Channel Manager</span>
                                    </Link>
                                </li>
