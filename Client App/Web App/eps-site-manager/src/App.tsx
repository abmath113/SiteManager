...
import ChannelManagerSearch from './pages/main/components/master/channelManager/channelmanagersearch';
...
const routes: RouteObject[] = [
    {
        ...
        children: [
            ...
            { path: "channelmanagersearch", element: <ChannelManagerSearch /> },
